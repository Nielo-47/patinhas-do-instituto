...
export const Footer = ({ variant = 'default' }: FooterProps) => {
  ...
  const bgClass = isDarkBg ? 'bg-primary' : 'bg-primary-dark';
  const textClass = isDarkBg ? 'text-secondary' : 'text-secondary-foreground';
  ...
  return (
    <footer className={`${bgClass} ${textClass} py-12 mt-auto`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className={`mb-4 ${isDarkBg ? 'text-secondary/80' : 'text-secondary-foreground/80'}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <Input
                ...
                className={`${isDarkBg ? 'bg-card text-secondary' : 'bg-card text-secondary'} border-accent`}
              />
              <Input
                type="email"
              ...
              <Textarea
                ...
                className={`${isDarkBg ? 'bg-card text-secondary' : 'bg-card text-secondary'} border-accent min-h-[100px]`}
              />
          ...
          <div>
            ...
            <p className={`mb-6 ${isDarkBg ? 'text-secondary/80' : 'text-secondary-foreground/80'}`}>
